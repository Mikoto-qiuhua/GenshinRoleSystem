package org.qiuhua.genshinattributesbackpack.combination;
...
import org.qiuhua.genshinattributesbackpack.armsfollow.FollowControl;
import org.qiuhua.genshinattributesbackpack.armsfollow.LockingArms;
import org.qiuhua.genshinattributesbackpack.attribute.AttributeControl;
...
import org.qiuhua.genshinattributesbackpack.suits.ArtifactsTag;
import org.qiuhua.genshinattributesbackpack.suits.SuitsAction;
...
public class Switch {
    ...
    public static void SwitchCombination(PlayerItemHeldEvent event){
        ...
        if(!player.isSneaking()){
            //判断是否需要取消武器显示
            LockingArms.cancelArmsFollow(event);
            return;
        }
