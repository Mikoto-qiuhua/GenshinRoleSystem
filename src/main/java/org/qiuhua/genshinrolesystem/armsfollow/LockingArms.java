...
public class LockingArms {
    ...
    //切换物品栏时判断是否取消显示
    public static boolean cancelArmsFollow(PlayerItemHeldEvent event){
        //切换后
        ...
        return isArmsSlot(newSlot);
    }

    public static boolean cancelArmsFollow(Player player){

        return isArmsSlot(player.getInventory().getHeldItemSlot());
    }
